...
<body class="hold-transition skin-green sidebar-mini <?= $this->uri->segment(1) == '' ? 'sidebar-collapse' : null ?>">
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown user user-menu">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								...
								<img src="<?= base_url('uploads/user/' . $this->fungsi->user_login()->image) ?>" class="user-image">
								<span class="hidden-xs"><?= $this->fungsi->user_login()->username ?></span>
							</a>
							<ul class="dropdown-menu">
								<li class="user-header">
									<img src="<?= base_url('uploads/user/' . $this->fungsi->user_login()->image) ?>" class="img-circle">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li <?= $this->uri->segment(1) == 'item' || $this->uri->segment(1) == '' ? 'class="active"' : '' ?>>
						<a href="<?= site_url('item') ?>"><i class="fa fa-archive"></i> <span>Menu</span></a>
					</li>
					<li class="treeview <?= $this->uri->segment(1) == 'stock' || $this->uri->segment(1) == 'sale' || $this->uri->segment(1) == 'payment' ? 'active' : '' ?>">
						...
						<ul class="treeview-menu">
							...
							<li <?= $this->uri->segment(1) == 'sale' ? 'class="active"' : '' ?>>
								<a href="<?= site_url('sale') ?>"><i class="fa fa-circle-o"></i> Daftar Pesanan</a>
							</li>
					...
					<li <?= $this->uri->segment(1) == 'report' ? 'class="active"' : '' ?>>
						<a href="<?= site_url('report/sale') ?>"><i class="fa fa-pie-chart"></i> <span>Laporan Transaksi</span></a>
					</li>
